{
    let canvas = document.getElementById('canvas_03_02')
    ...
    document.getElementById('button_03_02_01').onclick = () => {
        let X_2 = pointList_X.pop()
        let X_1 = pointList_X.pop()
        let Y_2 = pointList_Y.pop()
        let Y_1 = pointList_Y.pop()

        let delta_X = Math.abs(X_2 - X_1)
        let delta_Y = Math.abs(Y_2 - Y_1)

        let P = 2 * delta_Y - delta_X

        const const_01 = 2 * delta_Y
        const const_02 = 2 * (delta_Y - delta_X)
    ...
    document.getElementById('button_03_02_02').onclick = () => {
    ...
    canvas.onmouseenter = () => {
        ...
        canvas.onmousemove = (mouseEvent) => {
            ...
            document.getElementById('h4_03_02').innerText = `(${client_X} , ${client_Y})`
        }
    ...
    // e atualizar o Header que contém a posição do Mouse.
    canvas.onmouseleave = () => {
        document.getElementById('h4_03_02').innerText = '(0 , 0)'
    }
}
